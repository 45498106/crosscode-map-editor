...
export class TilemapDrawer extends Phaser.Plugin {
	...
	constructor(game: Phaser.Game, parent) {
		...
		this.selectedTiles.bitmap = game.make.bitmapData(30 * Globals.TILE_SIZE, 30 * Globals.TILE_SIZE, 'tilemapDrawer');
	...
	selectLayer(selectedLayer: CCMapLayer, map?: CCMap) {
		...
		this.tileSelectMap.visible = true;
